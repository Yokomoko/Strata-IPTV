...
fun MoviesScreen(
    ...
    // D-pad Up from the top rail must escape to the sidebar -- the hero
    // is a non-focusable Box, so without an explicit exit the first
    // rail's posters trap focus on Up.
